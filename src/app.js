...
classifier.addDocument('Hand Coloured Map of the settlement at Sydney Cove Port Jackson 1788. Cartographic material. Cartography. Map-making. Orienteering. Map reading. Latitude, longitude, terrain, contours. Navigation. Circumnavigate. Geo-tagging. WOEID. Googlemaps.' , 'Maps');
...
classifier.addDocument('traveled, traveling; travelled, travelling. Make a journey. driving excursion flying movement ride sailing sightseeing tour trek trip biking cruising drive expedition junket passage  ramble riding seafaring touring trekking voyage voyaging walk wandering wanderlust wayfaring globe-trotting overnight ', 'Travel');
...
classifier.addDocument('Portrait: a painting, drawing, photograph, or engraving of a person, especially one depicting only the face or head and shoulders. Effigy, still life, watercolour, oil painting, likeness, photograph, miniature, rubbings, locket, lookalike, dead ringer, stand-in. Likeness, statue, silhouette.', 'Portraits');
...
classifier.addDocument('Dirigible, airships, cable cars (aerial), Airport, flying, airplane. Transport, planes trains automobiles. Tram, Light rail, bicycle, motorbike. Freight, ferry, jetlag. Seasick. Airsick. Carsick. Car. Motor vehicle. Truck. Lorry. Dragster. Bike. Cyclist. Subway.', 'Transport');
...
classifier.addDocument('Inscribed. Jewellery, jewelry, boxes & cases, gold, diamonds, decorative art, treasures, museum, coins, stamps, numismatics, antiques, scrimshaw', 'Curios');
...
classifier.addDocument('Doge LOLcats LOL cats. Dogs, horses, unicorn, pets, animal lover, vegan, PETA, RSPCA, ASPCA, birds, budgie, fish, fish tank, aquarium, squirrel, hamster, mouse, rat, pet store, puppy, kitten, falconry, Attenborough, nature, ferret, turtle, tortoise, lizard, herp, Herpetology, frog, amphibian, zoology, zoo.', 'Animals');
  ...
  if ((tweet.text.substring(0,2) != 'RT')
    ...
    T.get('statuses/user_timeline', { user_id : uid , count: 20 })
      ...
      .then(function (result) {
        ...
        const btn = rows[row] + columns[clss];
        const resp = `OK @${tweet.user.screen_name} from the look of your tweets you might be interested in ${clss}. Try item ${btn}`;
