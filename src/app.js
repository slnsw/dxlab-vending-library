...
classifier.addDocument(
  'Hand Coloured Map of the settlement at Sydney Cove Port Jackson 1788. Cartographic material. Cartography. Map-making. Orienteering. Map reading. Latitude, longitude, terrain, contours. Navigation. Circumnavigate. Geo-tagging. WOEID. Googlemaps.',
  'Maps',
);
...
classifier.addDocument(
  'Dirigible, airships, cable cars (aerial), Airport, flying, airplane. Transport, planes trains automobiles. Tram, Light rail, bicycle, motorbike. Freight, ferry, jetlag. Seasick. Airsick. Carsick. Car. Motor vehicle. Truck. Lorry. Dragster. Bike. Cyclist. Subway.',
  'Transport',
);
  ...
  if (tweet.text.substring(0, 2) !== 'RT' && tweet.text.includes(hashTag)) {
    ...
    T.get('statuses/user_timeline', { user_id: uid, count: 20 })
      ...
      .then(result => {
        ...
        const resp = `OK @${tweet.user
          .screen_name} from the look of your tweets you might be interested in ${clss}. Try item ${btn}`;
